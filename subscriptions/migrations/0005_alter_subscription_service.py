...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("subscriptions", "0004_alter_subscription_service"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("gcp_dataproc", "GCP Dataproc"),
                    ("gcp_dataproc_os", "GCP Dataproc OS Images"),
                    ("gcp_memorystore_redis", "GCP Memorystore Redis"),
